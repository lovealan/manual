...
-- ----------------------------
INSERT INTO `prefix_xielei_manual_manual` VALUES ('1', 'ebcms/framework 手册', '', '', '', '', '', '1', '`ebcms/framework`是新一代的PHP开发框架，遵守业界广泛认同的**PSR标准规范**，是您不错的选择。', '', '1595486640', '1595496594');
