...
<ul class="pl-3" style="list-style:none;">
    ...
    <li style="list-style:none;">
        ...
        </svg><a href="{:$router->buildUrl('/xielei/manual/home/post',['id'=>$vo['alias']?:$vo['id']])}" class="ml-1 {if $vo['id']==$cur_id}text-danger font-weight-bold{/if}">{$vo.title}</a>
        {/if}
    </li>
    {/foreach}
    {else}
...
<div class="row">
    <div class="col-md-3">
        ...
        {:mulu($postModel, $manual['id'], 0, 0, $router)}
    </div>
    <div class="col-md-9">
        {foreach $posts as $vo}
        <div class="card my-2">
